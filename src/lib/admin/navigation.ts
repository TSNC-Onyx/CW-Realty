...
export const ADMIN_AREAS: AdminArea[] = [
  ...
  { key: "closed-deals", label: "Closed deals", href: "/admin/closed-deals", description: "Record sales from website leads and download them for Google and Meta.", group: "daily", roles: EDITOR_ROLES },
