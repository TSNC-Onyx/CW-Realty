...
const TYPE_LABELS: Record<TrashItem["item_type"], string> = { listings: "Listing", listing_photos: "Listing photo", team_members: "Team member" };
    ...
    <>
      ...
      {items.length === 0 ? (
        <EmptyState
          ...
          description="Listings, photos, and team members you delete show up here for 30 days."
